...
namespace PM2E2Grupo1.Views
{
    public partial class PageEdit : ContentPage
    {
        ...
        private async void btnAgregar_Clicked(object sender, EventArgs e)
        {
            ...
            bool isSuccess = await _apiService.UpdateDataAsync("/api/sitio", idItem, data);


            if (isSuccess)
            {
                HideLoadingDialog();
                await DisplayAlert("�Guardado!", "El sitio ha sido Actualizado", "OK");
